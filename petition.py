...
def petition(ide,oai_base,repo,lang="en",):
        body='{"id":"%s","lang":"%s","oai_base": "%s","repo":"%s"}' %(ide,lang,oai_base,repo)
        ...
        for key in result:
            ...
            print("In %s your item has %f points " % (key, round((g_points / g_weight),3),))
...
oai_base="https://www.ics-c.epos-eu.org/api/v1/resources/details"
repo="epos"
